...
> 面向不同专业背景学生的推荐侧重。所有路径共享计算思维基础（02–08）。
...
- [`21-llm`](../cards/21-llm.md) + [`llm-deep-dive`](../deep/llm-deep-dive.md)（医学问答 RAG）
...
- [`09`](../cards/09-computer-system-arch.md) · [`10`](../cards/10-software-engineering.md) · [`11`](../cards/11-computer-network.md) · [`12`](../cards/12-information-security.md)
- [`06`](../cards/06-graph-exploration.md) · [`07`](../cards/07-greedy-algorithm.md)
- [`17-machine-learning`](../cards/17-machine-learning.md) · [`21-llm`](../cards/21-llm.md)

## 材料/化学/物理科学生

重点：计算范式 + 量子计算 + 模拟。

- [`08-turing-machine`](../cards/08-turing-machine.md)
- [`09-computer-system-arch`](../cards/09-computer-system-arch.md)
...
- [`08-turing-machine`](../cards/08-turing-machine.md)
- [`05-data-structure-advanced`](../cards/05-data-structure-advanced.md) · [`06`](../cards/06-graph-exploration.md)
- [`17-machine-learning`](../cards/17-machine-learning.md) · [`reinforcement-learning`](../deep/reinforcement-learning.md)
