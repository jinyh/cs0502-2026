...
| # | 卡片 | 讲稿 | 支柱 | 定位 | tags |
|---|---|---|---|---|---|
| 01 | [welcome](../docs/cards/01-welcome.md) | Slide01 | — | 课程行政导引 | 课程导引 |
...
| 04 | [data-structure-basics](../docs/cards/04-data-structure-basics.md) | Slide04 | 计算 | 数组/栈/队列/链表/树/ADT | ADT/栈/队列/树 |
| 05 | [data-structure-advanced](../docs/cards/05-data-structure-advanced.md) | Slide05 | 计算 | 搜索与哈希 | 哈希/散列/冲突 |
...
| 08 | [turing-machine](../docs/cards/08-turing-machine.md) | Slide08 | 计算 | 可计算性边界 | 图灵机/停机/丘奇-图灵 |
| 09 | [computer-system-arch](../docs/cards/09-computer-system-arch.md) | Slide09 | 系统 | 冯诺依曼与存储层次 | CPU/指令周期/局部性 |
...
| 13 | [database](../docs/cards/13-database.md) | Slide13 | 数据 | 关系模型与 SQL | 关系/SQL/ACID/索引 |
...
| 17 | [machine-learning](../docs/cards/17-machine-learning.md) | Slide17 | 智能 | 从数据归纳 | 监督/无监督/过拟合/梯度 |
...
- 学生问某概念 → 先在「tags」列匹配，定位卡片，读其「核心知识点」与「直觉类比」作答。
- 学生问「最新/进展」→ 走 `frontier/` 静态层 + 联网增量（见 `AGENTS.md` 前沿检索）。
- 学生要深入 → 引导到 `deep/` 对应专题，而非自创内容。
- 学生问跨学科 → 读卡片「跨学科联系」+ `paths/by-discipline-bridge`。
